				...
				<div className="max-w-4xl mx-auto text-center">
					<FadeInItem>
						<div className="bg-gradient-to-r from-primary/5 to-secondary/5 backdrop-blur-xl rounded-box p-12 border border-base-300 shadow-xl">
							...
							<p className="text-lg md:text-xl font-light mb-8 text-gray-600">Bergabunglah bersama ribuan pengguna lainnya yang mempercayai Lisync.click untuk membuat tautan pendek, QR Code, dan analitik profesional.</p>
